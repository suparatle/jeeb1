...
public class RNPushNotificationListenerService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage message) {
        ...
        Log.v(LOG_TAG, "onMessageReceived2: " + remoteNotification);
        Log.v(LOG_TAG, "onMessageReceived3: " + data);
        ...
        handler.post(new Runnable() {
            public void run() {
                ...
                if (bundle.containsKey("toHeadless") && !isApplicationInForeground()) {
                    Log.v(LOG_TAG, "onMessageReceived4: ");
                    Intent headlessIntent = new Intent(
                        getApplicationContext(),
                        JeebNotiService.class
                      );
                    headlessIntent.putExtra("message", bundle);
                    getApplicationContext()
